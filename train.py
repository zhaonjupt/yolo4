...
if __name__ == "__main__":
    ...
    checkpoint = ModelCheckpoint(log_dir+"/ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.h5", save_weights_only=False, save_best_only=False, period=1)
    # 对早停法参数的配置，min_delta表明所能容忍的最小改善阈值，patience表明了所能容忍的最长无改进epoches
